...
_NON_BUYER_NAME_RE = re.compile(
    ...
    r"|街道办事处|机关|事业单位|研究院"
    # 出海中介服务商（2026-09-01 用户裁决：货代/代运营/客服外包**不是**目标客户——
    # 买家是品牌/卖家/工厂/游戏App + 建站工具 SaaS，不含劳动型服务商）。
    # 货物运输：子串漏网实测（「上海世双国际货物运输代理」不含「货代」
    # 也不含「货运」——货-物-运-输 相邻对是 物运 不是 货运）
    r"|货代|货运|货物运输|物流|船务|报关|仓储|快递|代运营|客服外包|呼叫中心"
    # 劳动型服务商族（2026-09-01 用户裁决「要」：与客服外包同族出池——
    # 人力资源/劳务派遣替别人招人、管理咨询/企业服务/信息服务卖服务给
    # 企业，都不是「用 WA 承接海外买家」的卖货方）
    r"|人力资源|劳务派遣|管理咨询|企业服务|信息服务"
